    ...
    <section className="relative overflow-hidden" id="about">
      ...
      <div className="container relative py-20 sm:py-40">
        <div className="mx-auto max-w-6xl text-center">
          <h1 className={`text-balance font-roboto text-2xl sm:text-4xl tracking-wider font-bold md:text-8xl text-white`}>
            Creating The Future of Software Technology
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-sm sm:text-lg text-gray-200">
          ...
          <div className="flex justify-center items-center gap-4">
            <Link href="https://www.upwork.com/agencies/1826147102571778048/" target="_blank">
              <Button
                size="lg"
                className="mt-8 font-bold rounded-full bg-primary text-white hover:bg-primary/80"
              >
              Hire Us
            </Button>
            </Link>
            ...
            <Button
              size="lg"
              className="mt-8 font-bold rounded-full bg-white text-primary hover:bg-primary/80 hover:text-white"
            >
                Showcase
              </Button>
            </Link>
